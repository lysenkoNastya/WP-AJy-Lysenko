...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar( array(
            'name'          => __( 'Footer-clients', 'understrap' ),
            'id'            => 'footer-top',
            'description'   => __( 'Footer top sidebar widget area', 'understrap'),
            'before_widget' => '<div class="footer-clients %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '',
            'after_title'   => '',
        ) );
        register_sidebar( array(
            'name'          => __( 'Footer-contact-us', 'understrap' ),
            'id'            => 'footer-center',
            'description'   => __( 'Footer top sidebar widget area', 'understrap'),
            'before_widget' => '<span class="contact-us-text">',
            'after_widget'  => '</span>',
            'before_title'  => '',
            'after_title'   => '',
        ) );
        register_sidebar( array(
            ...
            'id'            => 'footer-bottom',
            'description'   => __( 'Footer bottom sidebar widget area', 'understrap'),
        ...
        register_sidebar( array(
            'name'          => __( 'Sidebar-single-search-sone', 'understrap' ),
